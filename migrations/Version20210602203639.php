 ...
 */
final class Version20210602203639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE server (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, location_id INT NOT NULL, distribution_id INT NOT NULL, name VARCHAR(255) NOT NULL, ip VARCHAR(16) NOT NULL, state INT NOT NULL, cpu INT NOT NULL, ram INT NOT NULL, INDEX IDX_5A6DD5F6A76ED395 (user_id), INDEX IDX_5A6DD5F664D218E (location_id), INDEX IDX_5A6DD5F66EB6DDB5 (distribution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
